...
JokeRace frames currently support contests that are anyone can enter or anyone can vote. If your contest is anyone can enter, then you can use frames for the entry portion of your contest; if your contest is anyone can vote, then you can use frames for the voting portion of your contest; and if your contest is anyone can enter and anyone can vote, then you can use frames for every portion of your contest.

### What can I enter to a frame?

Frames currently only accept text-based entries. If you would like to enter media, pleast enter a link to wherever it is being hosted.

### How do I make a frame?

- If you'd like to share an entry frame, all you need to do is cast the link to the contest you'd like to share the frame for and it will auto-populate in Warpcast!
- If you'd like to share a voting frame, all you need to do is cast the link to the entry you'd like people to be able to vote with the frame on and it will auto-populate in Warpcast!
...
Monetization (you can set entry fees that we split with you 50/50)
