...
- Ethereum Mainnet (we do not recommend creating a contest here, as fees for using the chain can often run 100x the costs on other chain)
...
But this is just one example. In fact, because JokeRace is fully onchain, you can use any data point from contests to determine your own system of rewarding reputation. We actually created a Flipside dashboard you can use if you want to input your contest:

https://flipsidecrypto.xyz/0xd698e31229aB86334924ed9DFfd096a71C686900/jokerace-analytics-UIs4gX
...
## I’m allowlisting addresses that I got from one chain, but I’m deploying my contest to a different chain. (For example, I’m allowlisting anyone who holds a specific token on Ethereum Mainnet, but I’m deploying my contest on Berachain). Will these addresses work across different chains?
