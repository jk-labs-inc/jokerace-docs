...
We just shipped the ability for contest creators to direct where they want their earnings to go, which means that programmatic circuits can be built to supercharge engagement.
